...
namespace DAL.Impl.Transactions
{
    public class DbTransactionManager: ITransactionManager
    {
        private readonly CoataDbContext _context;
        private readonly ILogger<DbTransactionManager> _logger;

        public DbTransactionManager(CoataDbContext context, ILogger<DbTransactionManager> logger)
        {
            _context = context;
            _logger = logger;
        }
